...
abstract class SwipeToDeleteCallback(context: Context) : ItemTouchHelper.SimpleCallback(
    ...
    private val intrinsicWidth = deleteIcon!!.intrinsicWidth // Intrinsic = the exact size of the drawable
    private val intrinsicHeight = deleteIcon!!.intrinsicHeight
    private val background = ColorDrawable()
    private val backgroundColor = Color.parseColor("#DC3954")
    ...
    override fun onChildDraw(
        ...
        val deleteIconLeft = itemView.right - deleteIconMargin/2 - intrinsicWidth
        val deleteIconRight = itemView.right - deleteIconMargin/2
        val deleteIconBottom = deleteIconTop + intrinsicHeight

        // Draw the delete icon
        deleteIcon?.setBounds(deleteIconLeft, deleteIconTop, deleteIconRight, deleteIconBottom)
        deleteIcon?.draw(canv)
